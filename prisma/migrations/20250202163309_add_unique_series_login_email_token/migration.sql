/*
  ...
  - A unique constraint covering the columns `[series]` on the table `Equipament` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Equipament_series_key" ON "Equipament"("series");
